...
<<<<<<< Updated upstream
        ('葡萄牙国家男子足球队','葡萄牙国家足球队'),
=======
        # ('WTT球星挑战赛卢布尔雅那站','卢布尔雅那球星挑战赛'),
        ('Championship League Snooker', '2026年斯诺克排名赛版冠军联赛'),
        ('Shanghai Exhibition Match', '上海斯诺克表演赛'),
        ('女王杯', 'WTA女王俱乐部锦标赛'),
        ('斯图尔特·宾汉姆', '斯图亚特·宾汉姆'),
        ('诺鹏·桑坎姆', '诺蓬·桑坎姆'),
        ('特鲁尔斯·莫雷加德', '特鲁尔·莫雷加德'),
        ('蒂莫·波尔', '蒂姆·波尔'),
        ('菲利克斯·奥热-阿利亚西姆', '费利克斯·奥热-阿利亚西姆'),
        ('祖德·贝林厄姆', '裘德·贝林厄姆'),
        ('海顿·平海', '海登·平尼'),
        ('阿里斯特·卡特', '阿里·卡特'),
        ('内尔松·塞梅多', '纳尔逊·塞梅多'),
...
>>>>>>> Stashed changes
=======
        ('Masters','斯诺克大师赛'),('澳门羽毛球公开赛','2026年中国澳门羽毛球公开赛'),
        ('国际篮联世界杯预选赛','国际篮联篮球世界杯预选赛'),('葡萄牙国家男子足球队','葡萄牙国家足球队'),
>>>>>>> 5984f09b1478abc3ff23d26e48ef1a7d6660e9dc
    ]
